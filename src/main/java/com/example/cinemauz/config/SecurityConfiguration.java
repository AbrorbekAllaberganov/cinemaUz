package com.example.cinemauz.config;

import com.example.cinemauz.security.JwtAuthEntryPoint;
import com.example.cinemauz.security.JwtConfigurer;
...
//    }
    ...
    public void configure(HttpSecurity http) throws Exception{
        http
                ...
                .antMatchers("/api/owner/**").hasRole("ADMIN")
